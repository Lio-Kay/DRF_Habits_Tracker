    ...
    def __call__(self, value):
        ...
        if is_pleasant:
            ...
            if related_pleasant_habit and reward:
                raise serializers.ValidationError(
                    'У полезной привычки не может быть вознаграждения и приятной привычки одновременно.')
            if not (related_pleasant_habit or reward):
                raise serializers.ValidationError(
                    'У полезной привычки должно быть вознаграждение либо связанная приятная привычка.')
